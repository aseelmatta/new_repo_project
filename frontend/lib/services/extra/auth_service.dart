...
class AuthService {
  ...
  // Use the web client ID (client_type 3 in google-services.json) for server-side
  // verification instead of relying on the Android package+SHA1 restricted client.
  // This avoids the "Requests from this Android client application are blocked"
  // error when different developers use different debug keystores. See
  // https://stackoverflow.com/a/68228246/ for discussion. The value below comes
  // from the `client_type: 3` entry in `google-services.json`.
  static final GoogleSignIn _googleSignIn = GoogleSignIn(
    serverClientId: '554654911341-ksnhg4bnbgafjpnoqn1jcltrpg3ojfj9.apps.googleusercontent.com',
  );
